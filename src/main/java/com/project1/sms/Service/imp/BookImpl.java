...
//students
    ...
    public void postBook(BookRequest request) {
        Categories category = categoriesRepo.findById(request.CategoryId()).orElseThrow(() -> new ResourceNotFoundException("Categories not found"));
   ...
   //admin
    ...
    public void updateBook(Long bookId, BookRequest request) {
        Books book = bookRepo.findById(bookId).orElseThrow(() -> new ResourceNotFoundException("book is not found"));
        Categories category = categoriesRepo.findById(request.CategoryId()).orElseThrow(() -> new ResourceNotFoundException("category not found"));
    ...
    public void updateCategory(Long categoryId, CategoryRequest request) {
        Categories category = categoriesRepo.findById(categoryId).orElseThrow(() -> new ResourceNotFoundException("category is not found"));
    ...
    public CategoryResponse getCategory(Long categoryId) {
        Categories categories = categoriesRepo.findById(categoryId).orElseThrow(() -> new ResourceNotFoundException("category not found"));
